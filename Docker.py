...
# docker rmd2d813548126 - айді контейнера який хочеться видалити та команда видалить (можна ім'я)


# Docker stops containers that do not have active processes

# docjker run -it busybox  - connection to process 'sh'  (I  got inside the container created on busybox image)
# ls  - 
# hostname -i  -  ip adres of container

#ping 8.8.8.8 - access to internet
#ping google.com
